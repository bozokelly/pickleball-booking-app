...
export interface Profile {
  ...
  push_token: string | null; created_at: string; updated_at: string;
}
...
export interface Game {
  ...
  location: string | null; status: GameStatus; notes: string | null;
...
export interface Notification {
  ...
  type: NotificationType; reference_id: string | null; read: boolean; created_at: string;
}
