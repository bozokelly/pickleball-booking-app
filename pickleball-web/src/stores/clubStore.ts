...
interface ClubState {
  ...
  createClub: (club: Pick<Club, 'name' | 'description' | 'location'> & { latitude?: number | null; longitude?: number | null; manager_name?: string | null; contact_email?: string | null; contact_phone?: string | null; website?: string | null; members_only?: boolean }) => Promise<Club>;
